function ValidateQuery(query) {
    ...
    for(let i = 0; i < queries.length; i++) {
        if(queries[i].toUpperCase() === 'SELECT') {
            ...
            if(i + 1 < queries.length && queries[++i].toUpperCase() === 'AND') {
    ...
    return [selectArgument, fromArgument, whereArgument_1, whereArgument_2, whereArgument_3, andArgument_1, andArgument_2, andArgument_3, groupByArgument]
}
